...
/**
 * REST controller for managing {@link by.iba.masiuk.domain.Language}.
 */
@RestController
@RequestMapping("/api")
public class LanguageResource {
    ...
    public List<LanguageDTO> getAllLanguages(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
